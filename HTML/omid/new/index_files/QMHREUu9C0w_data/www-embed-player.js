...
var ba="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},ea="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this;
function fa(a,b){if(b){for(var c=ea,d=a.split("."),e=0;e<d.length-1;e++){var f=d[e];f in c||(c[f]={});c=c[f]}d=d[d.length-1];e=c[d];f=b(e);f!=e&&null!=f&&ba(c,d,{configurable:!0,writable:!0,value:f})}}
...
var F=nd(a,Z);if(F.length){var F=nd(a,k),ca=B(N,"CP",[]),da=ca.length;ca[da]=function(a){function b(){var a=ca[da+1];a&&a()}
function c(b){ca[da]=null;d(F,a)&&Tb(function(){e&&e();b()})}
if(!a)return 0;Dc("ml1",F,na);0<da&&ca[da-1]?ca[da]=function(){c(b)}:c(b)};
if(F.length){var fc="loaded_"+N.I++;Da[fc]=function(a){ca[da](a);Da[fc]=null};
a=cd(c,F,"gapi."+fc,k);k.push.apply(k,F);Dc("ml0",F,na);b.sync||wa.___gapisync?pd(a):qd(a)}else ca[da](za)}else d(F)&&e&&e()}
...
lg.prototype.o=function(){this.i=this.g=null;lg.A.o.call(this)};var mg=!!window.google_async_iframe_id,Kc=mg&&window.parent||window;var ng=null;function og(){var a=M("BG_I",null),b=M("BG_IU",null),c=M("BG_P",void 0);b?ag(b,function(){pg(c)}):a&&(eval(a),pg(c))}
function pg(a){ng=new botguard.bg(a);R("botguard_periodic_refresh")&&lb()}
function qg(){return null!=ng}
function rg(){return ng?ng.invoke():null}
;var sg=[],tg=!1;function ug(){function a(){tg=!0;"google_ad_status"in window?L("DCLKSTAT",1):L("DCLKSTAT",2)}
ag("//static.doubleclick.net/instream/ad_status.js",a);sg.push(ce(function(){tg||"google_ad_status"in window||($f("//static.doubleclick.net/instream/ad_status.js",a),L("DCLKSTAT",3))},1))}
function vg(){return parseInt(M("DCLKSTAT",0),10)}
;var Ra=r("ytEventsEventsListeners")||{};q("ytEventsEventsListeners",Ra,void 0);var wg=r("ytEventsEventsCounter")||{count:0};q("ytEventsEventsCounter",wg,void 0);function xg(a,b,c,d){d=void 0===d?!1:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Qa(function(e){return e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function yg(a,b,c){var d;d=void 0===d?!1:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=xg(a,b,c,d);if(e)return e;var e=++wg.count+"",f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document),g;g=f?function(d){d=new kb(d);if(!kf(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new kb(b);
...
function zg(a){a&&("string"==typeof a&&(a=[a]),O(a,function(a){if(a in Ra){var b=Ra[a],d=b[0],e=b[1],f=b[3],b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Ra[a]}}))}
;var Ag={"X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};
function Bg(a,b){b=void 0===b?{}:b;var c=void 0;c=window.location.href;var d=P(a)[1]||null,e=jc(P(a)[3]||null);d&&e?(d=c,c=P(a),d=P(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?jc(P(c)[3]||null)==e&&(Number(P(c)[4]||null)||null)==(Number(P(a)[4]||null)||null):!0;for(var f in Ag){if((e=d=M(Ag[f]))&&!(e=c)){var g=a,e=f,h=M("CORS_HEADER_WHITELIST")||{};e=(g=jc(P(g)[3]||null))?(h=h[g])?0<=Vb(h,e):!1:!0}e&&(b[f]=d)}return b}
function Cg(a,b){var c=M("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.qb&&(!jc(P(a)[3]||null)||b.withCredentials||jc(P(a)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.D&&b.D[c])}
function Dg(a,b){var c=b.format||"JSON";b.Ka&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=M("XSRF_FIELD_NAME",void 0),e=M("XSRF_TOKEN",void 0),f=b.kb;f&&(f[d]&&delete f[d],a=Sc(a,f||{}));var g=b.postBody||"",f=b.D;Cg(a,b)&&(f||(f={}),f[d]=e);f&&u(g)&&(d=Rc(g),Wa(d,f),g=b.wa&&"JSON"==b.wa?JSON.stringify(d):Tc(d));var h=!1,k,m=Eg(a,function(a){if(!h){h=!0;k&&window.clearTimeout(k);var d=tb(a),e=null;if(d||400<=a.status&&
500>a.status)e=Fg(c,a,b.pb);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||n;d?b.J&&b.J.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Qa&&b.Qa.call(f,a,e)}},b.method,g,b.headers,b.responseType,b.withCredentials);
b.O&&0<b.timeout&&(k=T(function(){h||(h=!0,m.abort(),window.clearTimeout(k),b.O.call(b.context||n,m))},b.timeout))}
function Fg(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=Ia(a));break;case "XML":if(b=(b=b.responseXML)?Gg(b):null)d={},O(b.getElementsByTagName("*"),function(a){d[a.tagName]=Hg(a)})}c&&Ig(d);
return d}
function Ig(a){if(la(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d;d=me(a[b]);a[c]=d}else Ig(a[b])}}
function Gg(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Hg(a){var b="";O(a.childNodes,function(a){b+=a.nodeValue});
return b}
function Jg(a,b){b.method="POST";b.D||(b.D={});Dg(a,b)}
function Eg(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&nc(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=sb();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c;if(e=Bg(a,e))for(var m in e)k.setRequestHeader(m,e[m]),"content-type"==m.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);return k}
;var Kg=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],Lg=['audio/mp4; codecs="mp4a.40.2"'];function Mg(){var a=!!M("WIDGET_ID_ENFORCE"),a=this.f=new Kf(a),b=v(this.ab,this);a.j=b;a.l=null;this.f.channel="widget";if(a=M("WIDGET_ID"))this.f.sessionId=a;this.i=[];this.l=!1;this.j={}}
l=Mg.prototype;l.ab=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.j[c]||"onReady"==c||(this.addEventListener(c,Ng(this,c)),this.j[c]=!0)}else this.Aa(a,b)};
l.Aa=function(){};
function Ng(a,b){return v(function(a){this.sendMessage(b,a)},a)}
...
function Og(a,b){a.sendMessage("infoDelivery",b)}
l.za=function(a){this.l?this.f.sendMessage(a):this.i.push(a)};
l.sendMessage=function(a,b){this.za({event:a,info:void 0==b?null:b})};
l.dispose=function(){this.f=null};var Pg;if(mg&&!Jc()){var Qg="."+sa.domain;try{for(;2<Qg.split(".").length&&!Jc();)sa.domain=Qg=Qg.substr(Qg.indexOf(".")+1),Kc=window.parent}catch(a){}Jc()||(Kc=window)}Pg=Kc;var Rg=new Lc(1,Pg);function Sg(){Pg.b||(O(Rg.events,Rg.g,Rg),Rg.events.length=0,Rg.b=!1)}
if("complete"==Pg.document.readyState)Sg();else if(Rg.b){var Tg=function(){Sg()};
Pg.addEventListener?Pg.addEventListener("load",Tg,eb?void 0:!1):Pg.attachEvent&&Pg.attachEvent("onload",Tg)};function Ug(a,b,c,d,e){c={name:c||M("INNERTUBE_CONTEXT_CLIENT_NAME",1),version:d||M("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e||!1;if(a&&e&&!(5<=Vg)){e=a.stacktrace;d=a.columnNumber;var f=r("window.location.href");if(u(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var g,h,k=!1;try{g=a.lineNumber||a.line||"Not available"}catch(E){g="Not available",k=!0}try{h=a.fileName||a.filename||a.sourceURL||n.$googDebugFname||f}catch(E){h=
"Not available",k=!0}a=!k&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:g,fileName:h,stack:a.stack||"Not available"}}e=e||a.stack;g=a.lineNumber.toString();isNaN(g)||isNaN(d)||(g=g+":"+d);if(!(Wg[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){h=a.fileName;b={kb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:g,level:b||"ERROR"},D:{url:M("PAGE_NAME",window.location.href),
file:h},method:"POST"};e&&(b.D.stack=e);for(var m in c)b.D["client."+m]=c[m];if(m=M("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var x in m)b.D[x]=m[x];Dg("/error_204",b);Wg[a.message]=!0;Vg++}}}
var Wg={},Vg=0;function Xg(a){this.b=a||rc()}
Xg.prototype.f=function(){return{context:qc(this.b)}};
Xg.prototype.g=function(a,b,c){M("VISITOR_DATA")||Q(Error("Missing VISITOR_DATA when sending innertube request."));var d={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":M("VISITOR_DATA","")},D:b,wa:"JSON",O:c.O,J:function(a,b){c.J&&c.J(b)},
onError:function(a,b){if(c.onError)c.onError(b)},
timeout:c.timeout,withCredentials:!0},e=Vc();e&&(d.headers.Authorization=e,d.headers["X-Goog-AuthUser"]=M("SESSION_INDEX",0));var f=this.b.xhrApiaryHost;f.startsWith("http")||(f="//"+f);if(R("youtubei_for_web")||R("unplugged_web_same_op_domain"))f="";var g=this.b.Oa;g&&(f=g);e&&!f&&(d.headers["x-origin"]=window.location.origin);Jg(""+f+sc(this.b.innertubeApiVersion,a,b)+"?alt=json&key="+this.b.innertubeApiKey,d)};var Yg={},Zg=0;function $g(a,b){a&&(M("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)?Eg(a,b):ah(a,b))}
function ah(a,b){var c=new Image,d=""+Zg++;Yg[d]=c;c.onload=c.onerror=function(){b&&Yg[d]&&b();delete Yg[d]};
c.src=a}
;function bh(){var a=Ua(ch);return new X(function(b,c){a.J=function(a){tb(a)?b(a):c(new dh("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new dh("Unknown request error","net.unknown"))};
a.O=function(){c(new dh("Request timed out","net.timeout"))};
Dg("//googleads.g.doubleclick.net/pagead/id",a)})}
function dh(a,b){D.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
aa(dh,D);function eh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function fh(a,b,c){u(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return gh(a)}
function gh(a,b,c){if(la(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function hh(a,b,c,d){if(la(a)&&!ia(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}c={index:b,startSeconds:c,suggestedQuality:d};u(a)&&16==a.length?c.list="PL"+a:c.playlist=a;return c}
function ih(a){var b=a.video_id||a.videoId;if(u(b)){var c=gg()||{},d=gg()||{};p(void 0)?d[b]=void 0:delete d[b];var e=y()+3E5,f=ig;if(f&&window.JSON){u(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function jh(){if(null==r("_lact",window)){var a=parseInt(M("LACT"),10),a=isFinite(a)?y()-Math.max(a,0):-1;q("_lact",a,window);q("_fact",a,window);-1==a&&kh();yg(document,"keydown",kh);yg(document,"keyup",kh);yg(document,"mousedown",kh);yg(document,"mouseup",kh);Af("page-mouse",kh);Af("page-scroll",kh);Af("page-resize",kh)}}
function kh(){null==r("_lact",window)&&(jh(),r("_lact",window));var a=y();q("_lact",a,window);-1==r("_fact",window)&&q("_fact",a,window);zf("USER_ACTIVE")}
function lh(){var a=r("_lact",window);return null==a?-1:Math.max(y()-a,0)}
;function mh(a,b,c){I.call(this);this.b=a;this.i=c;this.j=yg(window,"message",v(this.l,this));this.g=new lg(this,a,b);vb(this,w(wb,this.g))}
z(mh,I);mh.prototype.l=function(a){var b;if(b=!this.f)if(b=a.origin==this.i)a:{b=this.b;do{var c;b:{c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,u(a))){try{a=Ha(a)}catch(d){return}a.command&&(b=this.g,b.f||b.l("command",a.command,a.data))}};
mh.prototype.o=function(){zg(this.j);this.b=null;mh.A.o.call(this)};function nh(a){D.call(this,a.message||a.description||a.name);this.Pa=a instanceof oh;this.b=a instanceof Pe}
z(nh,D);nh.prototype.name="BiscottiError";function oh(){D.call(this,"Biscotti ID is missing from server")}
z(oh,D);oh.prototype.name="BiscottiMissingError";function ph(a,b){this.f=a;this.b=b}
ph.prototype.then=function(a,b,c){try{if(p(this.f))return a?Me(a.call(c,this.f)):Me(this.f);if(p(this.b)){if(!b)return Ne(this.b);var d=b.call(c,this.b);return!p(d)&&this.b.b?Ne(this.b):Me(d)}throw Error("Invalid Result_ state");}catch(e){return Ne(e)}};
Xa(ph);var ch={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},qh=null;function rh(){if(!qh){var a=v(sh,n,2),b=bh().then(th);qh=Oe(b,null,a,void 0)}return qh}
function th(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new oh;a=JSON.parse(a.substr(4)).id;uh(a);qh=new ph(a);vh(18E5,2);return a}
function sh(a,b){var c=new nh(b);uh("");qh=new ph(void 0,c);0<a&&vh(12E4,a-1);throw c;}
function vh(a,b){T(function(){var a=v(sh,n,b),a=bh().then(th,a);Oe(a,null,t,void 0)},a)}
function uh(a){q("yt.ads.biscotti.lastId_",a,void 0)}
;function wh(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||lb());f[a]=b;f.context={lastActivityMs:lh()};Qf({endpoint:"log_event",va:f,da:e},c)}
;function xh(a,b,c,d){yh(a,{attachChild:{csn:b,parentVisualElement:qb(c),visualElements:[qb(d)]}},void 0)}
function zh(a,b,c){c=Wb(c,function(a){return qb(a)});
yh(a,{visibilityUpdate:{csn:b,visualElements:c}})}
function yh(a,b,c){b.eventTimeMs=Math.round(lb());b.lactMs=lh();c&&(b.clientData=Ah(c));Qf({endpoint:"log_interaction",va:b},a)}
function Ah(a){var b={};a.analyticsChannelData&&(b.analyticsDatas=Wb(a.analyticsChannelData,function(a){return{tabName:a.tabName,cardName:a.cardName,isChannelScreen:a.isChannelScreen,insightId:a.insightId,externalChannelId:a.externalChannelId,externalContentOwnerId:a.externalContentOwnerId}}));
return{playbackData:{clientPlaybackNonce:a.clientPlaybackNonce},analyticsChannelData:b,externalLinkData:a.externalLinkData}}
;function Bh(a,b){tc.call(this,b);this.b=a;this.start()}
z(Bh,tc);Bh.prototype.addEventListener=function(a,b){this.b.addEventListener(a,b)};
Bh.prototype.removeEventListener=function(a,b){this.b.removeEventListener(a,b)};
function wc(a,b){switch(a){case "loadVideoById":return b=gh(b),ih(b),[b];case "cueVideoById":return b=gh(b),ih(b),[b];case "loadVideoByPlayerVars":return ih(b),[b];case "cueVideoByPlayerVars":return ih(b),[b];case "loadPlaylist":return b=hh(b),ih(b),[b];case "cuePlaylist":return b=hh(b),ih(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
Bh.prototype.ia=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Bh.A.ia.call(this,a,b)};
Bh.prototype.o=function(){Bh.A.o.call(this);delete this.b};function Ch(a){Mg.call(this);this.b=a;this.g=[];this.addEventListener("onReady",v(this.Wa,this));this.addEventListener("onVideoProgress",v(this.ib,this));this.addEventListener("onVolumeChange",v(this.jb,this));this.addEventListener("onApiChange",v(this.cb,this));this.addEventListener("onPlaybackQualityChange",v(this.fb,this));this.addEventListener("onPlaybackRateChange",v(this.gb,this));this.addEventListener("onStateChange",v(this.hb,this))}
z(Ch,Mg);l=Ch.prototype;l.Aa=function(a,b){if(this.b[a]){b=b||[];if(0<b.length&&eh(a)){var c;c=b;if(la(c[0])&&!ia(c[0]))c=c[0];else{var d={};switch(a){case "loadVideoById":case "cueVideoById":d=gh.apply(window,c);break;case "loadVideoByUrl":case "cueVideoByUrl":d=fh.apply(window,c);break;case "loadPlaylist":case "cuePlaylist":d=hh.apply(window,c)}c=d}ih(c);b.length=1;b[0]=c}this.b[a].apply(this.b,b);eh(a)&&Og(this,this.ja())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());Og(this,a)};
l.fb=function(a){Og(this,{playbackQuality:a})};
l.gb=function(a){Og(this,{playbackRate:a})};
...
l.jb=function(){Og(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.ib=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:y()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Og(this,a)};
l.dispose=function(){Ch.A.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function Dh(){return R("enable_youtubei_innertube")?Xg:nf}
;var Eh=r("ytLoggingLatencyUsageStats_")||{};q("ytLoggingLatencyUsageStats_",Eh,void 0);var Fh=0;function Gh(a){Eh[a]=Eh[a]||{count:0};var b=Eh[a];b.count++;b.time=lb();Fh||(Fh=ce(Hh,0));return 10<b.count?(11==b.count&&Ug(Error("CSI data exceeded logging limit with key: "+a)),!0):!1}
function Hh(){var a=lb(),b;for(b in Eh)6E4<a-Eh[b].time&&delete Eh[b];Fh=0}
;function Ih(){var a=M("ROOT_VE_TYPE",void 0);return a?new ob(void 0,a,void 0):null}
function Jh(){var a=M("client-screen-nonce",void 0);a||(a=M("EVENT_ID",void 0));return a}
;function Kh(a){I.call(this);this.b=[];this.g=a||this}
z(Kh,I);function Lh(a,b,c,d){d=nc(v(d,a.g));d={target:b,name:c,ra:d};b.addEventListener(c,d.ra,void 0);a.b.push(d)}
function Mh(a){for(;a.b.length;){var b=a.b.pop();b.target.removeEventListener(b.name,b.ra)}}
Kh.prototype.o=function(){Mh(this);Kh.A.o.call(this)};var Nh={vc:!0},Oh={ad_at:"adType",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",yt_vis:"isVisible",docid:"videoId",plid:"videoId",fmt:"playerInfo.itag"},Ph="ap c cver ei yt_fss yt_li".split(" "),Qh=["isNavigation","isMonetized","prerollAllowed","isRedSubscriber","isVisible"],Rh=v(H.clearResourceTimings||H.webkitClearResourceTimings||H.mozClearResourceTimings||H.msClearResourceTimings||
H.oClearResourceTimings||t,H);
function Sh(a){if("_"!=a[0]){var b=a;H.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),H.mark(b))}var b=Th(),c=lb();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;Uh()["tick_"+a]=void 0;lb();R("csi_on_gel")?(b=Vh(),"_start"==a?Gh("baseline_"+b)||wh("latencyActionBaselined",{clientActionNonce:b},Xg,void 0):Gh("tick_"+a+"_"+b)||wh("latencyActionTicked",{tickName:a,clientActionNonce:b},Xg,void 0),a=!0):a=!1;if(a=!a)a=!r("yt.timing.pingSent_");if(a&&(b=M("TIMING_ACTION",void 0),a=Th(),r("yt.timing.ready_")&&
b&&a._start&&Wh())){b=!0;c=M("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Xh()}}
function Yh(){var a=Zh().info.yt_lt="hot_bg";Uh().info_yt_lt=a;if(R("csi_on_gel"))if("yt_lt"in Oh){var b={},c=Oh.yt_lt.split(".");0<=Vb(Qh,c)&&(a=!!a);for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=Vh();c=Object.keys(b).join("");Gh("info_"+c+"_"+a)||(b.clientActionNonce=a,wh("latencyActionInfo",b,Xg))}else 0<=Vb(Ph,"yt_lt")||Q(Error("Unknown label yt_lt logged with GEL CSI."))}
function Wh(){var a=Th();if(a.aft)return a.aft;for(var b=M("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Xh(){if(!R("csi_on_gel")){var a=Th(),b=Zh().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&ia(a[d])){var e=d.slice(1);if(e in Nh){var f=Wb(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=r("yt.timing.reportbuilder_")){if(f=f(a,b,void 0))$h(f,e),ai(),Rh(),bi(!1,void 0),M("TIMING_ACTION")&&L("PREVIOUS_ACTION",M("TIMING_ACTION")),L("TIMING_ACTION","")}else{var g=M("CSI_SERVICE_NAME","youtube"),f={v:2,s:g,action:M("TIMING_ACTION",void 0)},h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+r("ytplayer.config.assets.js");(k=H.getEntriesByName?H.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
delete b.h5jse}a.aft=Wh();ci()&&"youtube"==g&&(Yh(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=lb();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=r("ytdebug.logTiming"))&&a(f,b);$h(f,e,void 0);Gf(new de(b.aft+(h||0),void 0))}}}
function $h(a,b,c){if(R("debug_csi_data")){var d=r("yt.timing.csiData");d||(d=[],q("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}var d="",e;for(e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b)try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||$g(a,void 0)}catch(f){$g(a,void 0)}else $g(a);bi(!0,c)}
function Vh(){var a=Zh().nonce;if(!a){var b;a:{if(window.crypto&&window.crypto.getRandomValues)try{var c=Array(16),d=new Uint8Array(16);window.crypto.getRandomValues(d);for(a=0;a<c.length;a++)c[a]=d[a];b=c;break a}catch(e){}b=Array(16);for(c=0;16>c;c++){d=y();for(a=0;a<d%23;a++)b[c]=Math.random();b[c]=Math.floor(256*Math.random())}if(Uc)for(c=1,d=0;d<Uc.length;d++)b[c%16]=b[c%16]^b[(c-1)%16]/4^Uc.charCodeAt(d),c++}c=[];for(d=0;d<b.length;d++)c.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(b[d]&
63));a=c.join("");Zh().nonce=a}return a}
function Th(){return Zh().tick}
function Uh(){var a=Zh();"gel"in a||(a.gel={});return a.gel}
function Zh(){return r("ytcsi.data_")||ai()}
function ai(){var a={tick:{},info:{}};q("ytcsi.data_",a,void 0);return a}
function bi(a,b){q("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function ci(){var a=Th(),b=a.pbr,c=a.vc,a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Zh().info.yt_pvis}
;function di(a,b){I.call(this);this.w=this.l=a;this.T=b;this.C=!1;this.g={};this.Z=this.S=null;this.U=new Y;vb(this,w(wb,this.U));this.j={};this.L=this.aa=this.i=this.ha=this.b=null;this.W=!1;this.M=this.B=this.H=this.R=null;this.ba={};this.Ca=["onReady"];this.X=new Kh(this);vb(this,w(wb,this.X));this.fa=null;this.oa=NaN;this.Y={};ei(this);this.G("onDetailedError",v(this.Ta,this));this.G("onTabOrderChange",v(this.Ea,this));this.G("onTabAnnounce",v(this.pa,this));this.G("WATCH_LATER_VIDEO_ADDED",v(this.Ua,
this));this.G("WATCH_LATER_VIDEO_REMOVED",v(this.Va,this));pe||(this.G("onMouseWheelCapture",v(this.Ra,this)),this.G("onMouseWheelRelease",v(this.Sa,this)));this.G("onAdAnnounce",v(this.pa,this));this.N=new Kh(this);vb(this,w(wb,this.N));this.ga=!1;this.ea=null}
z(di,I);var fi=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];l=di.prototype;l.na=function(a,b){this.f||(gi(this,a),hi(this,b),this.C&&ii(this))};
function gi(a,b){a.ha=b;a.b=Qb(b);a.i=a.b.attrs.id||a.i;"video-player"==a.i&&(a.i=a.T,a.b.attrs.id=a.T);a.w.id==a.i&&(a.i+="-player",a.b.attrs.id=a.i);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.T;a.aa||(a.aa=ji(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.w.style.width=Hf(Number(c)||c));if(c=a.b.attrs.height)a.w.style.height=Hf(Number(c)||c)}
l.Ha=function(){return this.ha};
function ii(a){a.b.loaded||(a.b.loaded=!0,"0"!=a.b.args.autoplay?a.g.loadVideoByPlayerVars(a.b.args):a.g.cueVideoByPlayerVars(a.b.args))}
function ki(a){if(!p(a.b.disable.flash)){var b=a.b.disable,c;c=we(ve.getInstance(),a.b.minVersion);b.flash=!c}return!a.b.disable.flash}
function li(a,b){if((!b||(5!=(Rb[b.errorCode]||5)?0:-1!=fi.indexOf(b.errorCode)))&&ki(a)){var c=mi(a);c&&c.stopVideo&&c.stopVideo();var d=a.b;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=Pb(c));d.args.autoplay=1;d.args.html5_unavailable="1";gi(a,d);hi(a,"flash")}}
function hi(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&ki(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==xe)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Kg:Lg,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=ni(a)||a.b.assets.js);
a.b.disable.html5=!d;d||(a.b.args.html5_unavailable="1")}c=!!a.b.disable.html5}b=c?ki(a)?"flash":"unsupported":"html5"}("flash"==b?a.lb:a.mb).call(a)}}
function ni(a){var b=!0,c=mi(a);c&&a.b&&(a=a.b,b=hb(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
l.mb=function(){if(!this.W){var a=ni(this);if(a&&"html5"==oi(this))this.L="html5",this.C||this.P();else if(pi(this),this.L="html5",a&&this.H)this.l.appendChild(this.H),this.P();else{this.b.loaded=!0;var b=!1;this.R=v(function(){b=!0;var a=this.l,d=Qb(this.b);r("yt.player.Application.create")(a,d);this.P()},this);
this.W=!0;a?this.R():(ag(this.b.assets.js,this.R),cg(this.b.assets.css),qi(this)&&!b&&q("yt.player.Application.create",null,void 0))}}};
l.lb=function(){var a=Qb(this.b);if(!this.B){var b=mi(this);b&&(this.B=document.createElement("SPAN"),this.B.tabIndex=0,Lh(this.X,this.B,"focus",this.ta),this.M=document.createElement("SPAN"),this.M.tabIndex=0,Lh(this.X,this.M,"focus",this.ta),b.parentNode&&b.parentNode.insertBefore(this.B,b),b.parentNode&&b.parentNode.insertBefore(this.M,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==oi(this))this.L="flash",this.C||this.P();else{pi(this);this.L=
...
l.ta=function(){mi(this).focus()};
function mi(a){var b=gf(a.i);!b&&a.w&&a.w.querySelector&&(b=a.w.querySelector("#"+a.i));return b}
l.P=function(){if(!this.f){var a=mi(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.W=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))li(this);else{ei(this);this.C=!0;a=mi(this);a.addEventListener&&(this.S=ri(this,a,"addEventListener"));a.removeEventListener&&(this.Z=ri(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.g[d]||(this.g[d]=ri(this,a,d))}for(var e in this.j)this.S(e,
this.j[e]);ii(this);this.aa&&this.aa(this.g);this.U.V("onReady",this.g)}else this.oa=T(v(this.P,this),50)}};
function ri(a,b,c){var d=b[c];return function(){try{return a.fa=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.fa=e,Q(e,"WARNING"))}}}
function ei(a){a.C=!1;if(a.Z)for(var b in a.j)a.Z(b,a.j[b]);for(var c in a.Y)window.clearTimeout(parseInt(c,10));a.Y={};a.S=null;a.Z=null;for(var d in a.g)a.g[d]=null;a.g.addEventListener=v(a.G,a);a.g.removeEventListener=v(a.bb,a);a.g.destroy=v(a.dispose,a);a.g.getLastError=v(a.Ia,a);a.g.getPlayerType=v(a.Ja,a);a.g.getCurrentVideoConfig=v(a.Ha,a);a.g.loadNewVideoConfig=v(a.na,a);a.g.isReady=v(a.nb,a)}
l.nb=function(){return this.C};
l.G=function(a,b){if(!this.f){var c=ji(this,b);if(c){if(!(0<=Vb(this.Ca,a)||this.j[a])){var d=si(this,a);this.S&&this.S(a,d)}this.U.subscribe(a,c);"onReady"==a&&this.C&&T(w(c,this.g),0)}}};
l.bb=function(a,b){if(!this.f){var c=ji(this,b);c&&yc(this.U,a,c)}};
function ji(a,b){var c=b;if("string"==typeof b){if(a.ba[b])return a.ba[b];c=function(){var a=r(b);a&&a.apply(n,arguments)};
a.ba[b]=c}return c?c:null}
function si(a,b){var c="ytPlayer"+b+a.T;a.j[b]=c;n[c]=function(c){var d=T(function(){if(!a.f){a.U.V(b,c);var e=a.Y,g=String(d);g in e&&delete e[g]}},0);
Ta(a.Y,String(d))};
return c}
...
l.Ja=function(){return this.L||oi(this)};
l.Ia=function(){return this.fa};
function oi(a){return(a=mi(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function pi(a){Sh("dcp");a.cancel();ei(a);a.L=null;a.b&&(a.b.loaded=!1);var b=mi(a);"html5"==oi(a)?ni(a)||!qi(a)?a.H=b:(b&&b.destroy&&b.destroy(),a.H=null):b&&b.destroy&&b.destroy();for(var b=a.l,c;c=b.firstChild;)b.removeChild(c);Mh(a.X);a.B=null;a.M=null}
l.cancel=function(){this.R&&$f(this.b.assets.js,this.R);window.clearTimeout(this.oa);this.W=!1};
l.o=function(){pi(this);if(this.H&&this.b)try{this.H.destroy()}catch(b){Q(b)}this.ba=null;for(var a in this.j)n[this.j[a]]=null;this.ha=this.b=this.g=null;delete this.l;delete this.w;di.A.o.call(this)};
function qi(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;function ti(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=M("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){var d=a,e=M("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=jc(P(window.location.href)[3]||null);f&&e.push(f);f=jc(P(d)[3]||null);if(0<=Vb(e,f)||!f&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(e=document.createElement("a"),Fe(e,d),d=e.href),d){var f=P(d),d=f[5],e=f[6],f=f[7],g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
Jh();d="ST-"+db(d).toString(36);e=b?Tc(b):"";Bb.set(""+d,e,5,"/","youtube.com");b&&(b=b.itct||b.ved,d=r("yt.logging.screen.storeParentElement"),b&&d&&d(new ob(b)))}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var h,k,m;h=void 0===h?{}:h;k=void 0===k?"":k;m=void 0===m?window:m;c=m.location;a=kc(mc([a],h))+k;a=a instanceof zd?a:Dd(a);c.href=Bd(a)}return!0}
;function ui(a){a.Pa&&vi("")}
function wi(a){!a||r("yt.ads.biscotti.getId_")||r("yt.www.ads.biscotti.getId_")||q("yt.ads.biscotti.getId_",rh,void 0);try{var b;try{var c=r("yt.ads.biscotti.getId_")||r("yt.www.ads.biscotti.getId_");b=c?c():rh()}catch(d){b=Ne(d)}b.then(vi,ui);T(wi,18E5)}catch(d){Q(d)}}
var xi=0;
function vi(a){var b;a:{try{b=window.top.location.href}catch(F){b=2;break a}b=null!=b?b==window.document.location.href?0:1:2}b={dt:ta,flash:Hb||"0",frm:b};b.u_tz=-(new Date).getTimezoneOffset();var c;try{c=A.history.length}catch(F){c=0}b.u_his=c;b.u_java=!!A.navigator&&"unknown"!==typeof A.navigator.javaEnabled&&!!A.navigator.javaEnabled&&A.navigator.javaEnabled();A.screen&&(b.u_h=A.screen.height,b.u_w=A.screen.width,b.u_ah=A.screen.availHeight,b.u_aw=A.screen.availWidth,b.u_cd=A.screen.colorDepth);A.navigator&&
...
for(var na in d)b[na]=d[na]}b.bsq=xi++;Jg("//www.youtube.com/ad_data_204",{Ka:!1,D:b})}
;var yi={},zi="player_uid_"+(1E9*Math.random()>>>0);function Ai(a,b){a=u(a)?gf(a):a;b=Pb(b);var c=zi+"_"+ma(a),d=yi[c];if(d)return d.na(b),d.g;d=new di(a,c);yi[c]=d;zf("player-added",d.g);vb(d,w(Bi,d));T(function(){d.na(b)},0);
return d.g}
function Bi(a){yi[a.T]=null}
function Ci(a){a=gf(a);if(!a)return null;var b=zi+"_"+ma(a),c=yi[b];c||(c=new di(a,b),yi[b]=c);return c.g}
;var Di=r("yt.abuse.botguardInitialized")||qg;q("yt.abuse.botguardInitialized",Di,void 0);var Ei=r("yt.abuse.invokeBotguard")||rg;q("yt.abuse.invokeBotguard",Ei,void 0);var Fi=r("yt.abuse.dclkstatus.checkDclkStatus")||vg;q("yt.abuse.dclkstatus.checkDclkStatus",Fi,void 0);var Gi=r("yt.player.exports.navigate")||ti;q("yt.player.exports.navigate",Gi,void 0);var Hi=r("yt.player.embed")||Ai;q("yt.player.embed",Hi,void 0);var Ii=r("yt.player.getPlayerByElement")||Ci;q("yt.player.getPlayerByElement",Ii,void 0);
var Ji=r("yt.util.activity.init")||jh;q("yt.util.activity.init",Ji,void 0);var Ki=r("yt.util.activity.getTimeSinceActive")||lh;q("yt.util.activity.getTimeSinceActive",Ki,void 0);var Li=r("yt.util.activity.setTimestamp")||kh;q("yt.util.activity.setTimestamp",Li,void 0);var Mi=null,Ni=null,Oi=null,Pi={};function Qi(a){wh(a.payload_name,a.payload,R("enable_youtubei_innertube")?Xg:nf,void 0,void 0)}
function Ri(a){var b=a.id;a=a.ve_type;var c=pb++;a=new ob(void 0,a,c,void 0);Pi[b]=a;b=Jh();c=Ih();b&&c&&xh(Dh(),b,c,a)}
function Si(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(L("client-screen-nonce",b),L("ROOT_VE_TYPE",a),a=Ih()))for(var c in Pi){var d=b,e=a,f=Pi[c];xh(Dh(),d,e,f)}}
function Ti(a){Pi[a.id]=new ob(a.tracking_params)}
function Ui(a){var b=Jh();a=Pi[a.id];if(b&&a){var c=Dh();yh(c,{click:{csn:b,visualElement:qb(a)}},void 0)}}
function Vi(a){a=a.ids;var b=Jh();if(b){for(var c=[],d=0;d<a.length;d++){var e=Pi[a[d]];e&&c.push(e)}c.length&&zh(Dh(),b,c)}}
function Wi(){var a=Mi;a&&a.startInteractionLogging&&a.startInteractionLogging()}
;q("yt.setConfig",L,void 0);q("yt.config.set",L,void 0);q("yt.setMsg",pc,void 0);q("yt.msgs.set",pc,void 0);q("yt.logging.errors.log",Ug,void 0);
q("writeEmbed",function(){var a=M("PLAYER_CONFIG",void 0);"1"!=a.privembed&&wi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=M("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);M("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&ih(a.args);Mi=a=Ai("player",a);a.addEventListener("onScreenChanged",Si);a.addEventListener("onLogClientVeCreated",Ri);a.addEventListener("onLogServerVeCreated",Ti);a.addEventListener("onLogToGel",
Qi);a.addEventListener("onLogVeClicked",Ui);a.addEventListener("onLogVesShown",Vi);a.addEventListener("onReady",Wi);b=M("POST_MESSAGE_ID","player");M("ENABLE_JS_API")?Oi=new Ch(a):M("ENABLE_POST_API")&&u(b)&&u(c)&&(Ni=new mh(window.parent,b,c),Oi=new Bh(a,Ni.g));M("BG_P")&&(M("BG_I")||M("BG_IU"))&&og();ug()},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){$g(a+"mac_204?action_fcts=1");return!0},void 0);
var Xi=nc(function(){Sh("ol");var a=Mc.getInstance(),b=1<window.devicePixelRatio;if(!!((Pc("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Pc(c)||0,d=b?d|67108864:d&-67108865;0==d?delete S[c]:S[c]=d.toString(16).toString();var a=a.b,b=[],e;for(e in S)b.push(e+"="+escape(S[e]));Bb.set(""+a,b.join("&"),63072E3,"/","youtube.com")}}),Yi=nc(function(){var a=Mi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();M("PL_ATT")&&(ng=null);for(var a=0,b=sg.length;a<b;a++){var c=sg[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):window.clearTimeout(c)}}sg.length=0;a=Xf("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))yf(a),b.parentNode.removeChild(b);tg=!1;L("DCLKSTAT",0);xb(Oi,Ni);if(a=Mi)a.removeEventListener("onScreenChanged",Si),a.removeEventListener("onLogClientVeCreated",Ri),a.removeEventListener("onLogServerVeCreated",
Ti),a.removeEventListener("onLogToGel",Qi),a.removeEventListener("onLogVeClicked",Ui),a.removeEventListener("onLogVesShown",Vi),a.removeEventListener("onReady",Wi),a.destroy();Pi={}});
window.addEventListener?(window.addEventListener("load",Xi),window.addEventListener("unload",Yi)):window.attachEvent&&(window.attachEvent("onload",Xi),window.attachEvent("onunload",Yi));}).call(this);
